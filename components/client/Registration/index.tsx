   ...
   return(
    <div className={s.registration}>
        ...
        <form onSubmit = {onsubmit} className={s.formRegistration}>
                ...
                <TextField type='text' fieldname={'phoneNumber'} label='Phone Number' changefunction={onchange}/>
                <TextField type='password' fieldname={'password'} label='Password' changefunction={onchange}/>
                <TextField type='password' fieldname={'comfirmPassword'}label='Comfirm Password' changefunction={onchange}/>
